...
\cs_new_protected:Npn \@@_new_noto_font_face:nnn #1#2#3
  { \@@_new_font_face:nnx { noto-#1 } { Noto #2 -Regular.ttf } { Path=./fonts/noto-fonts/unhinted/Noto #2/, #3 } }
...
\@@_new_noto_font_face:nnn { albanian          } { SansCaucasianAlbanian    } {}
...
\@@_new_font_face:nnn { shsans           } { SourceHan.ttc                } { Path=./fonts/, FontIndex=17           }  % Source Han Sans SC Regular
\@@_new_font_face:nnn { shserif          } { SourceHan.ttc                } { Path=./fonts/, FontIndex=55           }  % Source Han Serif SC Regular
